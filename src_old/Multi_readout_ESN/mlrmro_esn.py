...
def parse_args_esn():
    ...
    parser.add_argument("--local_batch_size", type=int, default=80, help="Micro batch size per GPU")
    ...
    parser.add_argument("--total_tokens", type=float, default=5e9, help="Total number of tokens to train on")
    ...
    parser.add_argument("--dataset_path", type=str, default="/home/ach17664ll/GPTvsESN/dataset", help="Dataset path for Training")
    parser.add_argument("--val_dataset_path", type=str, default="vesteinn/babylm", help="Dataset path for Validation")
    # Weights & Biases
    parser.add_argument("--wandb_project", type=str, default="ESN SAES", help="WandB project name")
...
def ESN_experiment(lr,num_readouts,reservoir_size):
    ...
    if is_master:
        ...
        if "HF_WRITE_TOKEN" in api_keys and success_flag:
            repo_id, api = prepare_hf_repo_id(api_keys["HF_WRITE_TOKEN"], args.hf_repo, default_prefix=f"ESN{param_millions:.2f}M_200MT_mlr_N{args.reservoir_size}_mlo_{num_readouts}")
