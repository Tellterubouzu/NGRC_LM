...
def main():
    ...
    parser.add_argument("--runs_csv", type=str, default="run_table_65536_0827.csv", help="id, seed, PPL, model_path を含む CSV")
    parser.add_argument("--out_csv", type=str, default="reservoir_metrics_65536_0827.csv")
