...
# CSVファイルを読み込み
esn_df = pd.read_csv('run_table_metrics_65536_0827.csv')
gpt_df = pd.read_csv('run_table_gpt.csv')
...
box_plot = plt.boxplot([esn_val_perplexity_values, gpt_val_perplexity_values], patch_artist=True)
...
# x軸のラベルを設定
plt.xticks([1, 2], ['ESN-53M', 'GPT-2-54M'], fontsize=14)
